...
from policies import random_policy, brain_policy, lqr
...
class TemplateSimulatorSession():
    def __init__(self, render=False, log_data=False, log_file_name=None, env_name="QuanserQube"):
        self.render = render
...
if __name__ == "__main__":
    ...
    if args.test_random:
        ...
        test_policy(
            render=args.render, log_iterations=args.log_iterations, policy=lqr
        )
