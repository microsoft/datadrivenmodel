...
R = 0.1125
max_vel = 2
default_config = {"initial_x":np.random.uniform(-R*0.01,R*0.01),"initial_y":np.random.uniform(-R*0.01,R*0.01),"initial_vel_x":np.random.uniform(-0.01,0.01), 
        "initial_vel_y":np.random.uniform(-0.01,0.01),"initial_roll": np.random.uniform(-0.1,0.1), "initial_pitch": np.random.uniform(-0.1,0.1)}
