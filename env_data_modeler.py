...
class env_nn_modeler():
    ...
    def create_model(self, config):
        ...
        self.model.add(Dense(config["n_neuron"], input_dim=self.input_dim, activation = config["activation"], kernel_initializer='glorot_normal'))
        for i in range(0,num_hidden_layers):
            self.model.add(Dense(config["n_neuron"], activation='relu',kernel_initializer ='glorot_normal'))
        self.model.add(Dense(self.output_dim, activation='tanh', kernel_initializer = 'glorot_normal'))
